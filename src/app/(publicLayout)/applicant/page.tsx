...
export default function ApplicantPage() {
  ...
  const filteredPersons = useMemo(() => {
    return initialPersons.filter((person) => {
      ...
      if (!person.isApprove) return false;
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          ...
          <p className="text-muted-foreground text-sm">
            Showing {filteredPersons.length} matches
          </p>
        </div>

        {/* Filters bar */}
        <div className="bg-card border border-border rounded-md p-3 md:p-6 mb-6 shadow-sm">
            ...
            <div className="space-y-2.5">
              ...
              <div className="relative group">
                ...
                >
                  ...
                  {division &&
                    BANGLADESH_LOCATIONS[division].map((dist) => (
